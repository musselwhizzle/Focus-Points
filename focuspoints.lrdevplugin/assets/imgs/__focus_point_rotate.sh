...
do
    ...
    `gm convert _focus_point_redgrey_center.png -background transparent -gravity center -extent 45x45+0+0 -gravity center -rotate -$i -gravity center -extent 45x45+0+0 -flop -type TrueColor -quality 100 focus_point_redgrey_center_$i-mirrored.png`
    `gm convert _focus_point_redgrey_corner.png -background transparent -gravity center -extent 45x45+0+0 -gravity center -rotate -$i -gravity center -extent 45x45+0+0 -flop -type TrueColor -quality 100 focus_point_redgrey_corner_$i-mirrored.png`
    `gm convert _focus_point_redgrey_corner-small.png -background transparent -gravity center -extent 45x45+0+0 -gravity center -rotate -$i -gravity center -extent 45x45+0+0 -flop -type TrueColor -quality 100 focus_point_redgrey_corner-small_$i-mirrored.png`
