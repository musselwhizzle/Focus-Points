  ...
  LrFunctionContext.callWithContext("showDialog", function(context)
    ...
    LrTasks.startAsyncTask(function(context)
      ...
      LrFunctionContext.callWithContext("innerContext", function(dialogContext)
        ...
        local overlayView = rendererTable.createView(targetPhoto, photoW, photoH)

        dialogScope:done()

        -- Note that focusPointView is not local because used below
        focusPointView = FocusPointDialog.createDialog(targetPhoto, overlayView)
      end)
